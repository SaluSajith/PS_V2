...
public class GiveawayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @Override
    public GiveawayAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mRootView = LayoutInflater.from(context).inflate(R.layout.row_trending, parent, false);
        return new GiveawayAdapter.ViewHolder(mRootView);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, int position) {
        GiveawayAdapter.ViewHolder holder = (GiveawayAdapter.ViewHolder) holder1;
        ...
        holder.txt_description.setMinLines(0);
    ...
    private void setUiPageViewController(GiveawayAdapter.ViewHolder holder, int position) {
