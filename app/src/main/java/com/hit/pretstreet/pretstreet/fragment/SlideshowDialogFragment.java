...
import com.hit.pretstreet.pretstreet.customview.TouchImageView;
...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    private ArrayList<StoreDetailFragment.ProductImageItem> images;
...
//        lblDate.setText(image.getTimestamp());
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = LayoutInflater.from(getActivity()).inflate(R.layout.image_fullscreen_preview, container, false);

            TouchImageView imageViewPreview = (TouchImageView) view.findViewById(R.id.image_preview);

            StoreDetailFragment.ProductImageItem image = images.get(position);
